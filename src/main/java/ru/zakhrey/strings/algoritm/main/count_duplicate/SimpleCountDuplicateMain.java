...
public class SimpleCountDuplicateMain {

    public static void main(String[] args) {

        CountDuplicateCharsService countService = new CountDuplicateCharSimpleImpl();

        List<Double> xValues = NumpyUtils.linspace(10_000, 1_000_000, 100);
        ...
        drawPlot(timePlot,
            buildPlotSettings("Simple characters counting time plot",
