...
public class StreamCountDuplicateMain {

    public static void main(String[] args) {

        CountDuplicateCharsService countService = new CountDuplicateCharStreamImpl();
        ...
        drawPlot(timePlot,
            buildPlotSettings("Stream characters counting time plot",
